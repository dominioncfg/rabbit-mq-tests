...
Console.Title = "Topic Exchange - Subscriber Two";
Console.WriteLine("*****Welcome to the Topic Exchange Subscriber Two*****");
const string HostName = "localhost";
const string ExchangeName = "TopicExchange";
string SubscribedRoutingKey = $"employees.*";
string QueueName = $"TopicExchangeAllEmployeesQueue";
