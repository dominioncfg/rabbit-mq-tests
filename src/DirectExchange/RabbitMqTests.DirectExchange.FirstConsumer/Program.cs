...
Console.Title = "Direct Exchange - One Subscriber";
Console.WriteLine("*****Welcome to the Direct Exchange Subscriber One*****");
const string HostName = "localhost";
const string ExchangeName = "DirectExchange";
const string SubscribedRoutingKey = EmployeeTypes.Manager;
