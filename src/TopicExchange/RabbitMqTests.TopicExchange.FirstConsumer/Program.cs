...
Console.Title = "Topic Exchange - One Subscriber";
Console.WriteLine("*****Welcome to the Topic Exchange Subscriber One*****");
const string HostName = "localhost";
const string ExchangeName = "TopicExchange";
string SubscribedRoutingKey = $"employees.{EmployeeTypes.Manager}";
string QueueName = $"TopicExchangeManagersQueue";
